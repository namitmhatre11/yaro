...
<html lang="en" data-slide="1">
  ...
  <body> 
       <div class="large-banner yaro-banner">
          <img src="img/large-bg.jpg" class="full-width">
          <div class="qna-wrpr clearfix">
            <div class="yaro-quest-wrpr">
              ...
              <img class="tw-img" src="img/tw-icon-l.png">
            ...
            <div class="yaro-ans-wrpr">
              ...
              <img class="tw-img-r" src="img/tw-icon-l.png">
